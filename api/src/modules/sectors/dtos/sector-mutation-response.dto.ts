...
// Field names/shape follow `endpoints-sinaliza.md` §12.2/§12.3 literally:
// unlike the list endpoint (`SectorResponseDTO`, full `responsible_users`
// objects), create/update echo back only `responsible_user_ids`.
